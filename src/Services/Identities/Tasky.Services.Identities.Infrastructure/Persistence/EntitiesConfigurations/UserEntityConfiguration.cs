...
public class UserEntityConfiguration : IEntityTypeConfiguration<User>
{
    public void Configure(Microsoft.EntityFrameworkCore.Metadata.Builders.EntityTypeBuilder<User> builder)
    {
        ...
        builder.Property(s => s.Email).IsRequired().HasMaxLength(100).HasColumnName("email");
        builder.Property(s => s.Password).IsRequired().HasMaxLength(300).HasColumnName("password");
        ...
        builder.HasIndex(s => s.Email).IsUnique().HasDatabaseName("ux_users_email");
